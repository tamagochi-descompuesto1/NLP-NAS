...
if __name__ == '__main__':
    ...
    model = BertForMaskedLM.from_pretrained('models/smallbenchnlp/bert-small')
    print('Model loaded.')
    ...
    stats.set_stats()
    output = test_model('smallbenchnlp/bert-small', model, input_text)

    print(output)
    
    path = 'stat_dumps/bert-small/bert-small-test-' + time.strftime("%Y-%m-%d_%H-%M-%S", time.localtime()) + '.txt' 
